...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('enable/product', 'ProductController@enableProduct')->name('product.enable');
        Route::post('disable/product', 'ProductController@disableProduct')->name('product.disable');
        ...
        Route::get('remove/image/{id}/{name}', 'ProductController@removeImage')->name('product.image.remove');

        //Promo Banner
        Route::get('all/promo-banner', 'AdvertiseController@advertisements')->name('advertise.all');
        Route::post('promo-banner/store', 'AdvertiseController@advertisementStore')->name('advertise.store');
        Route::post('promo-banner/store', 'AdvertiseController@advertisementStore')->name('advertise.store');
        Route::post('promo-banner/update/{id}', 'AdvertiseController@advertisementUpdate')->name('advertise.update');
        Route::post('promo-banner/remove', 'AdvertiseController@advertisementRemove')->name('advertise.remove');

        //Manage Orders
        Route::get('processing/orders', 'ProductController@processing')->name('order.processing');
        Route::get('completed/orders', 'ProductController@completed')->name('order.completed');
        Route::get('rejected/orders', 'ProductController@rejected')->name('order.rejected');
        Route::get('/{scope}/search', 'ProductController@search')->name('order.search');
        Route::get('date-search/{scope}', 'ProductController@dateSearch')->name('order.dateSearch');
        Route::post('complete/orders', 'ProductController@complete')->name('order.complete');
        Route::get('order/details/{code}', 'ProductController@orderDetails')->name('order.details');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            //Purchase Log
            Route::get('purchase-log', 'UserController@purchaseLog')->name('purchase.log');

            //Product Download
            Route::get('product-download/{id}', 'UserController@productDownload')->name('product.download');

            //Order Details
            Route::get('order-details/{code}', 'UserController@orderDetails')->name('order.details');
...
Route::get('category/{id}', 'SiteController@categorySearch')->name('category.search');
Route::get('subcategory/{id}', 'SiteController@subcategorySearch')->name('subcategory.search');
Route::get('product/filtred', 'SiteController@productFilter')->name('product.filtered');
Route::get('loadmore/products', 'SiteController@loadmoreProducts')->name('loadmore.products');

//Add To Cart
Route::post('product/add-to-cart', 'SellController@addToCart')->name('addtocart');
Route::post('product/remove-cart', 'SellController@removeCart')->name('remove.cart');

//Go to Cart
Route::get('cart', 'SellController@cart')->name('cart');
...
//Company Policy
Route::get('pages/{id}-{slug}', 'SiteController@policy')->name('policy');
