        ...
        <div class="col-xl-6 mb-30">
            <div class="row mb-none-30">
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--dark text-white">
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--3 text-white">
                        <div class="widget-three__icon b-radius--rounded bg--15  box--shadow2">
                            <i class="lab la-product-hunt"></i>
                        </div>
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$orders['total_orders']}}</h2>
                            <p class="text--small">@lang('Total Orders')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--15">
                        <div class="widget-three__icon b-radius--rounded bg--3  box--shadow2">
                            <i class="lab la-product-hunt"></i>
                        </div>
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$orders['completed_orders']}}</h2>
                            <p class="text--small text-white">@lang('Completed Orders')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--10">
                        <div class="widget-three__icon b-radius--rounded bg--15  box--shadow2">
                            <i class="lab la-product-hunt"></i>
                        </div>
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$orders['processing_orders']}}</h2>
                            <p class="text--small text-white">@lang('Processing Orders')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
            </div>
