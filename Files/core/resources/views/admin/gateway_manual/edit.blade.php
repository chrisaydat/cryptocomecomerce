                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xl-5 col-md-12">
                                            ...
                                            <div class="input-group has_append">
                                                ...
                                                <input type="text" class="form-control" placeholder="0" name="rate" value="{{ showAmount(@$method->single_currency->rate,8,false,true) }}"/>
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="min_limit" placeholder="0" value="{{ showAmount(@$method->single_currency->min_amount,8,false,true) }}"/>
                                                </div>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="max_limit" value="{{ showAmount(@$method->single_currency->max_amount,8,false,true) }}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="fixed_charge" value="{{ showAmount(@$method->single_currency->fixed_charge,8,false,true) }}"/>
                                                </div>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="percent_charge" value="{{ showAmount(@$method->single_currency->percent_charge,2,false,true) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
