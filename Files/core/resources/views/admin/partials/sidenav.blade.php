            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.advertise*')}}">
                    <a href="{{route('admin.advertise.all')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Manage Promo Banner')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.order*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.order.processing')}}">
                                <a href="{{route('admin.order.processing')}}" class="nav-link">
                                    ...
                                    @if($processing_order_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$processing_order_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.order.rejected')}}">
                                <a href="{{route('admin.order.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
