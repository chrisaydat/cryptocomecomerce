                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="currency[{{ $currencyIdx }}][min_amount]" value="{{ showAmount($gatewayCurrency->min_amount,8,false,true) }}" placeholder="0" required/>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][max_amount]" value="{{ showAmount($gatewayCurrency->max_amount,8,false,true) }}" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][fixed_charge]" value="{{ showAmount($gatewayCurrency->fixed_charge,8,false,true) }}" required/>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][percent_charge]" value="{{ showAmount($gatewayCurrency->percent_charge,2,false,true) }}" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][rate]" value="{{ showAmount($gatewayCurrency->rate,8,false,true) }}" required/>
                                                            <div class="input-group-append">
